...
public class StringManager {
    ...
    public static final java.lang.String ERROR_COMMAND_LINE_ARGUMENTS = "Need command line arguments ! Please enter a filename in the .bin format. \nIf you are executing the program with the make command, then use the following syntax\n\nmake program file=<filename.bin>\n";
    ...
    public static final String ERROR_FILE_NOT_FOUND = "\n\nOops! .bin file not found. Please try running again with a valid file name. " +
            "Check that the file exists in the working directory.\nAre you sure this file is in the .bin format ?\n";
}
